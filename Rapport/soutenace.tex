...
\column{0.4\textwidth}
\centering
\includegraphics[width=\linewidth]{images/shéma_scenemanager.png}
...
Les entités gèrent le \textbf{rendu}

Les scènes gèrent la \textbf{logique}

Chaque scène a une entité

L'entité traduit la logique décidée en éléments graphiques concrets

Elle interagit directement avec le client : lien clics clients - logique évenement
