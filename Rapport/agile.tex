...
Au-delà de l’aspect ludique, ce projet constituait un exercice complet d’ingénierie logicielle mobilisant plusieurs compétences techniques : architecture client-serveur, synchronisation réseau, génération procédurale de contenu, intelligence artificielle et conception d’interface graphique.
